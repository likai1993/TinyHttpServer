...
public:
    ...
    std::string get_header_by_name(const std::string);
...
public:
     ...
     */
    http_response_t(const http_request_t& request, const std::string& web_root, bool redirect_mode, const std::string& backend_server_addr);
...
public:
    ...
    bool bind(std::string addr, port_t port = DEFAULT_PORT);
